...
async def async_setup_entry(
    ...
    entity = HwControl(name, linked_entity, entry)
...
def register_services():
    def set_value_when_auto(entity: HwControl, service_call):
        entity.set_value_when_auto(service_call.data["value"])

    def turn_on(entity: HwControl, service_call):
        entity.select_option(TXT_ON)

    def turn_off(entity: HwControl, service_call):
        entity.select_option(TXT_OFF)

    def set_auto(entity: HwControl, service_call):
